...
$.ajax({
    ...
    data: {
        key:'KZCBZ-W77WT-2BQXI-LLGEZ-REID6-SVBUT',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(32.967890, 117.218868, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
